...
public final class ZonaGialla_Tracciamento extends AbstractSnzScenario2020_Milan {
	...
	private static ConfigBuilder basePolicy(ActivityParticipation activityParticipation, Map<String, Double> ciCorrections,
		...
		if (restrictUniversities) { //Applica restrizioni uni
			restrictions.restrict("2020-03-04", Restriction.of(0.2), "university");
		}

		if(restrictNoEssentials) { //Applico restrizioni
			restrictions.restrict("2020-03-09", Restriction.of(0), "turism", "leisure", "night");
			//Ristoro
			restrictions.restrict("2020-03-09",Restriction.ofClosingHours(18,5),"refreshment");
			restrictions.restrict("2020-03-09",Restriction.of(0.7),"refreshment");
			restrictions.restrict("2020-03-09",Restriction.ofReducedGroupSize(4),"refreshment");
			//Shop non essenziali
			restrictions.restrict("2020-03-09",Restriction.of(0.7),"shop_noEss");
			...
			//Lavoro etc.
			restrictions.restrict("2020-03-09", Restriction.of(0.8), "work_ess","work_noEss","business", "shop_ess");
		}
	...
	public Config config() { //Prima funzione avviata
		...
		config.controler().setOutputDirectory("./output-ZonaGialla_Tracciamento");
	...
	public static class BasePolicyBuilder {
		...
		private boolean restrictSchoolsAndDayCare = false; //Chiusura scuole
