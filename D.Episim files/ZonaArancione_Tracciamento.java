...
public final class ZonaArancione_Tracciamento extends AbstractSnzScenario2020_Milan {
	...
	public Config config() { //Prima funzione avviata
		...
		config.controler().setOutputDirectory("./output-ZonaArancione_Tracciamento");
